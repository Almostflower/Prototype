...
public class DustManager : MonoBehaviour
{
	...
	void Start()
    {
		SoundManager.SingletonInstance.PlayBGM(SoundManager.BGMLabel.stage2);
	}
	...
	private void Update()
    {
		...
		{
			SoundManager.SingletonInstance.PlayBGM(SoundManager.BGMLabel.stage3);
		}
	}
	...
	private void OnesOpenClose()
	{
		...
		else
		{
			...
			{
				SoundManager.SingletonInstance.PlaySE(SoundManager.SELabel.JumpVoice, 0);
